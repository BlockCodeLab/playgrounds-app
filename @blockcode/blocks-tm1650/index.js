...
`}},{id:"displayRaw",text:l(o,{id:"blocks.tm1650.displayRaw",defaultMessage:"display raw value [RAW] and dot at [POS]"}),inputs:{RAW:{type:"hex16",defaultValue:"0"},POS:{menu:["-","0","1","2","3"]}},ino(n,e){r(this);let i=isNaN(e.RAW)?e.RAW:`"${e.RAW.replace(/^0x/,"")}"`,s="";if(s+=`_digit1650.displayString(String(${i}).c_str());
...
`;return i}},{id:"clear",text:l(o,{id:"blocks.tm1650.clear",defaultMessage:"clear display"}),ino(n){return r(this),`_digit1650.clear();
`},mpy(n){return`_digit1650.clear()
`}},"---",{id:"brightness",text:l(o,{id:"blocks.tm1650.brightness",defaultMessage:"set brightness [LEVEL]"}),inputs:{LEVEL:{shadow:"brightnessLevel",defaultValue:"7"}},ino(n){return r(this),`_digit1650.setBrightness(${this.valueToCode(n,"LEVEL",this.ORDER_NONE)});
