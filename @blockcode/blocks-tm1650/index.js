...
`}},{id:"brightnessLevel",shadow:!0,output:"number",inputs:{LEVEL:{type:"slider",defaultValue:0,min:0,max:7}},mpy(s){return[s.getFieldValue("LEVEL")||0,this.ORDER_NONE]},ino(s){return[s.getFieldValue("LEVEL")||0,this.ORDER_NONE]}}];var o="./assets/tm1650-24gbmkn4.py";var _="./assets/decimal1650-hmk55hpe.py";var g=(t)=>!["@blockcode/gui-arduino","@nulllab/gui-lgtuino"].includes(t.editor),f=(t)=>{if(g(t))return[{name:"decimal1650",type:"text/x-python",uri:_},{common:!0,name:"tm1650",type:"text/x-python",uri:o}];return[]};var d={en:{"blocks.tm1650.name":"TM1650 4-Digit","blocks.tm1650.init":"set pins SCL:[SCL] SDA:[SDA]","blocks.tm1650.addr":"set I2C address [ADDR]","blocks.tm1650.display":"display number [NUM]","blocks.tm1650.digit":"set digit [DIGIT] at [POS]","blocks.tm1650.brightness":"set brightness [LEVEL]","blocks.tm1650.clear":"clear display"},"zh-Hans":{"blocks.tm1650.name":"TM1650 四位数码管","blocks.tm1650.init":"初始引脚 SCL:[SCL] SDA:[SDA]","blocks.tm1650.addr":"初始 I2C 地址[ADDR]","blocks.tm1650.display":"显示数字[NUM]","blocks.tm1650.digit":"将第[POS]位数字设为[DIGIT]","blocks.tm1650.brightness":"将亮度设为[LEVEL]","blocks.tm1650.clear":"清除显示"},"zh-Hant":{"blocks.tm1650.name":"TM1650 四位數碼管","blocks.tm1650.init":"初始引腳 SCL:[SCL] SDA:[SDA]","blocks.tm1650.addr":"初始 I2C 地址[ADDR]","blocks.tm1650.display":"顯示數字[NUM]","blocks.tm1650.digit":"將第[POS]位數字設為[DIGIT]","blocks.tm1650.brightness":"將亮度設為[LEVEL]","blocks.tm1650.clear":"清除顯示"}};var p="./assets/icon-aw6e2381.png";import{jsx as h}from"preact/jsx-runtime";y(d);var C={icon:p,name:h(S,{id:"blocks.tm1650.name",defaultMessage:"TM1650 4-Digit"}),files:f,blocks:l};export{C as default};
