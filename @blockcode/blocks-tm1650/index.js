...
`}},{id:"displayRaw",text:r(o,{id:"blocks.tm1650.displayRaw",defaultMessage:"display raw value [RAW] and dot at [POS]"}),inputs:{RAW:{type:"hex16",defaultValue:"0"},POS:{menu:["-","0","1","2","3"]}},ino(s,e){n(this);let i=isNaN(e.RAW)?e.RAW:`"${e.RAW.replace(/^0x/,"")}"`,l="";if(l+=`_digit1650.displayString(String(${i}).c_str());
